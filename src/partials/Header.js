      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          {/* Site navigation */}
            ...
            {!loggedInUser.email ? <ul className="flex flex-grow justify-end flex-wrap items-center">
                <li>
              ...
              :
              <div className="flex flex-grow justify-end flex-wrap items-center font-bold">
